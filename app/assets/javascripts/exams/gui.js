  ...
  examRow(exam){
    ...
    html += `<td>
      <div class="float-right">
        ...
        <a class="btn btn-sm btn-danger" data-confirm="Are you sure?" rel="nofollow" data-method="delete" data-remote="true" href="/patients/${exam.patientId}/exams/${exam.id}">Destroy</a>
      </div>
    </td>`
    return html += `</tr>`
  }
